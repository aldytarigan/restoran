        ...
        <div class="col">
            <div class="card">
                ...
                <div class="col-lg-12">
                    ...
                    <button class="btn btn-green mb-3" data-toggle="modal" data-target="#tambahpegawaimodal"><i class="fa fa-plus"></i> Tambah Pegawai</button>
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>admin/tambah_pegawai" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Aldy Tarigan" name="nama" required>
                        <label>Email</label>
                        <input type="text" class="form-control" placeholder="aldytrgn@gmail.com" name="email" required>
                        ...
                        <label>Alamat</label>
                        <input type="text" class="form-control" placeholder="Jl. Al-Hidayah GG Hj. Gumat III, Cawang, Jakarta Timur" name="alamat" required>
                        <label>Telepon</label>
                        <input type="text" class="form-control" placeholder="081122334455" name="telepon" required>
                    </div>
            </div>
